    ...
    <>
      <div className="rodape">
        ...
        <div className="imgFooter">
          ...
          <div>
            <a
              href="https://www.facebook.com/projetomenstrua"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://www.instagram.com/projetomenstrua/"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://www.linkedin.com/company/menstrua"
              target="_blank"
              rel="noreferrer"
            >
      ...
      <div className="rodape__cc">
        <p>
          © 2023 | menstRUA | Site desenvolvido por{" "}  
          <a
            className="autora"
            href="https://github.com/jumara-pimenta"
            target="_blank"
            rel="noreferrer"
          >
            Jumara Pimenta
